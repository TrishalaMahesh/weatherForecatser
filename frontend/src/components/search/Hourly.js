...
class Hourly extends Component {
        ...
        if(data && data.hourly){
            ...
            return ( 
                <Paper className={classes.root} style={{ backgroundColor: "lightblue" }}>
                     ...
                     <div style={{ width: "100%", height: "100%"}}><h6>As of {moment(new Date()).tz(data.timezone).format("LT")} on {moment(new Date()).tz(data.timezone).format("MM/DD/YYYY")}</h6></div>
    ...
    render(){
        ...
        return(
            <div style={{paddingLeft:"2rem", backgroundColor:"lightblue"}}>
                <p>Hourly Weather</p>
