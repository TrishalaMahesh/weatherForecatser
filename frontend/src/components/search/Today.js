...
const Today = (props) => {
  ...
  return (
    ...
    <div className="d-flex justify-content-center" style={{ border: "solid black", width: "80%", margin: "auto", height: "80vh", backgroundColor: "lightblue" }}>
      <div className="card" style={{ width: "100%", height: "100%", backgroundColor: "lightblue" }}>
